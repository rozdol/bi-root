...
class Calendar_Event extends Event_Observer {
	...
	public function notify($data)
	{
		...
		if ((isset($this->conditions['easter']))||(isset($this->conditions['easter_fr']))||(isset($this->conditions['easter_mo']))||(isset($this->conditions['easter_tu']))||(isset($this->conditions['easter_gr']))||(isset($this->conditions['easter_pc'])))
		{
			//if ($condition['month'] === 2 OR $condition['month'] === 3 OR $condition['month'] === 4 OR $condition['month'] === 6)
			if ($condition['month']>0)
			{
				...
				$condition['easter_fr'] = ($condition['month'] === $month AND $condition['day'] === ($day-2));
				$condition['easter_mo'] = ($condition['month'] === $month AND $condition['day'] === ($day+1));
				$condition['easter_tu'] = ($condition['month'] === $month AND $condition['day'] === ($day+2));
				$condition['easter_gr'] = ($condition['month'] === ($month-1) AND $condition['day'] === ($day-17));
				$condition['easter_pc'] = ($condition['month'] === ($month+2) AND $condition['day'] === ($day-11));
			}
			else
			{
