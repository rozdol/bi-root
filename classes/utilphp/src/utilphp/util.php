...
class util
{
     ...
     * @return string
     */
    public static function var_dump($var, $return = false, $expandLevel = 1, $title='')
    {
        self::$hasArray = false;
        ...
        $html .= '</pre>';
        $html = "<h3 class='foldered $class'><i class='' style='margin-right:26px;' data-original-title=''></i>$title</h3>".$html;
        if (self::$hasArray) {
            $html = $jsCode . $html;
        }
