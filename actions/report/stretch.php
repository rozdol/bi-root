...
<param name='movie' value='".ASSETS_URI."/assets/swf/$chart?str=$data' />
<param name='quality' value='high' />
<param name='bgcolor' value='#ffffff' />
<embed src='".ASSETS_URI."/assets/swf/$chart?mode=vis&&str=$data' quality='high' bgcolor='#ffffff' width='$w' height='$h' name='vs' align='middle' allowScriptAccess='sameDomain' type='application/x-shockwave-flash' pluginspage='http://www.macromedia.com/go/getflashplayer' />
</object>
   </div>";		
	}
