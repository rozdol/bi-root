...
if ($what == 'profile'){
		...
		$id=$res[id]*1;
		if($id==0){$out.= "Your data is not inserted yet. <a href='?act=edit&table=$what&id=$id'><img src='".APP_URI."/assets/img/custom/edit.png'> Edit User</a>";exit;}
		...
		$out.= "<div class='alert alert-info'><a href='?act=edit&table=$what&id=$id'><img src='".APP_URI."/assets/img/custom/edit.png'> Edit User</a> .::. <a href='?act=edit&table=employees&id=$id'><img src='".APP_URI."/assets/img/custom/edit.png'> Edit Employee</a></div>";
