...
$proc_file=APP_DIR.DS.'/procedures/form/'.$table_name.'.php';
...
$proc_file=APP_DIR.DS.'/procedures/show/'.$table_name.'.php';
if(!file_exists($proc_file)){
	if(!file_put_contents($proc_file, $text))echo "ERR $proc_file<br>";;
};
...
$proc_file=APP_DIR.DS.'/procedures/save/'.$table_name.'.php';
if(!file_exists($proc_file)){
	if(!file_put_contents($proc_file, $text))echo "ERR $proc_file<br>";;
};
...
$proc_file=APP_DIR.DS.'/procedures/details/'.$table_name.'.php';
if(!file_exists($proc_file)){
	if(!file_put_contents($proc_file, $text))echo "ERR $proc_file<br>";;
};
