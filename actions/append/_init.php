...
$allowed = array('partners', 'accounts', 'services', 'a_accounts','contracts','plans','lots','piles','transport','projects','clients','assesment_items','uploads','transactions','trustsw','loans','entities','drugs','deals','deal_volumes','deal_ports','clientrequests','invoices','charges','properties','documents','events','cases','account_transactions','a_transactions','myprojects','a_transactions','appointments','approvals','assesments','assets','bank_records','bills','departments','employees','passports','posts','processes','resolutions','shareholders','trusts','visits','vacations','zoom_accounts','zoom_meetings','broker_accounts');
if ($table!='') {
